 ...
 * <strong>If your command might take longer than 3 seconds to execute, you must defer your reply with
 * {@link SlashCommand#deferReply()}.</strong>
 */
...
public @interface SlashCommand {
     ...
     *
     * <p>
     * <a href="https://en.wikipedia.org/wiki/Glob_(programming)">Glob patterns</a> are supported.
     ...
     * Send your replies through the {@link InteractionHook} via
     * <code>{@link SlashCommandEvent}.getHook().sendMessage(...)</code>
     * 
     * @return whether DiscordSRV should automatically defer the interaction's reply when routing the event to your
     *         handler
     */
