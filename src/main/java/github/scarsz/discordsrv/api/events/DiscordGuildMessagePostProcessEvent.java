...
/**
 * <p>
 * Called directly after a message from Discord was processed but before being broadcasted to the Minecraft server
 * </p>
 *
 * <p>
 * At the time this event is called, {@link #getProcessedMessage()} would return what the final message
 ...
 * {@link #setCancelled(boolean)} to cancel it from being broadcasted altogether
 * </p>
 */
@SuppressWarnings({ "LombokGetterMayBeUsed", "LombokSetterMayBeUsed" })
public class DiscordGuildMessagePostProcessEvent extends DiscordEvent<GuildMessageReceivedEvent>
    ...
    @Deprecated
    public DiscordGuildMessagePostProcessEvent(GuildMessageReceivedEvent jdaEvent, boolean cancelled,
