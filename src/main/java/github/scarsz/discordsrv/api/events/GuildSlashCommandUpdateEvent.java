...
/**
 * <p>
 * Called before slash command updates are sent to discord when
 * {@link github.scarsz.discordsrv.api.ApiManager#updateSlashCommands()} is called.
 * This event is called once for each {@link Guild}
 * </p>
 *
 * <p>
 * You could change what commands are included by modifying the {@link Set} of slash commands with
