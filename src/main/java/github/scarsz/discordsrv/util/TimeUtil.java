...
public class TimeUtil {
    ...
    static {
        timestampFormat = new SimpleDateFormat(
            DiscordSRV.config()
                .getOptionalString("TimestampFormat")
                .orElse("EEE, d. MMM yyyy HH:mm:ss z"));
        dateFormat = new SimpleDateFormat(
            DiscordSRV.config()
                .getOptionalString("DateFormat")
                .orElse("yyyy-MM-dd"));
        consoleTimeFormat = new SimpleDateFormat(
            DiscordSRV.config()
                .getOptionalString("DiscordConsoleChannelTimestampFormat")
                .orElse("EEE HH:mm:ss"));

        String timezone = DiscordSRV.config()
            .getOptionalString("Timezone")
            .orElse("default");
